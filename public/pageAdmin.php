    ...
    <div class="page-wrapper">
        <aside class="menu-sidebar2">
            ...
            <div class="menu-sidebar2__content js-scrollbar1">
                ...
                <nav class="navbar-sidebar2" id="wrapper">
                    <ul class="list-unstyled navbar__list" id="sidebar-wrapper">
                        <li>
                            <a href="?page">
                        ...
                        <li>
                            <a href="?page=adminTransaksi">
                                <i class="fas fa-shopping-basket"></i>Data Barang Keluar</a>
                        </li>
                        <li>
                            <a href="?page=viewSupplier">
                                <i class="fas fa-users"></i>Data Supplier</a>
                        </li>
                        <li>
                            <a href="?page=viewMerek">
                                <i class="fas fa-filter"></i>Data Merek</a>
                        </li>
                    </ul>
                </nav>
            </div>
        ...
        <div class="page-container2">
                ...
                <div class="menu-sidebar2__content js-scrollbar2">
                    ...
                    <nav class="navbar-sidebar2">
                        <ul class="list-unstyled navbar__list">
                            ...
                            <li>
                                <a href="?page=viewPegawai"><i class="fas fa-users"></i>Data Pegawai</a>
                            </li>
                            <li>
                                <a href="?page=viewBarang"><i class="fas fa-archive"></i>Data Barang Masuk</a>
                            </li>
                            <li>
                                <a href="?page=adminTransaksi"><i class="fas fa-shopping-basket"></i>Data Barang Keluar</a>
                            </li>
                            <li>
                                <a href="?page=viewSupplier"><i class="fas fa-users"></i>Data Supplier</a>
                            </li>
                            <li>
                                <a href="?page=viewMerek"><i class="fas fa-filter"></i>Data Merek</a>
                            </li>
                            <li>
            ...
            switch ($page) {
                case 'viewPegawai':
                    ...
                    break;
                case 'viewBarang':
                    include "pages/admin/viewBarang.php";
                    break;
                case 'viewSupplier':
                    include "pages/admin/viewSupplier.php";
                    break;
                case 'viewMerek':
                    include "pages/admin/viewMerek.php";
                    break;
                case 'addBarang':
                    include "pages/admin/addBarang.php";
                    break;
                case 'viewBarangDetail':
                    include "pages/admin/viewBarangDetail.php";
                    break;
                case 'viewBarangEdit':
                    include "pages/admin/viewBarangEdit.php";
                    break;
                case 'profil':
                    include "pages/profil.php";
                    break;
                case 'adminTransaksi':
                    include "pages/admin/transaksi/adminTransaksi.php";
                    break;
                case 'adminPembayaran':
                    include "pages/admin/transaksi/adminPembayaran.php";
                    break;
                case 'struk':
                    include "pages/admin/transaksi/strukTransaksi.php";
                    break;
                default:
                    $page = "dashboard";
