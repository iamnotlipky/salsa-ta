        ...
        <nav class="navbar-sidebar2">
            <ul class="list-unstyled navbar__list">
                ...
                <?php if ($_SESSION['level'] == "Admin") : ?>
                    ...
                    <li><a href="?page=data-lokasi"><i class="fas fa-barcode"></i>Kelola Data Lokasi</a></li>
                ...
                <?php elseif ($_SESSION['level'] == "Checker") : ?>
                    <li><a href="?page=input-barang-masuk"><i class="fas fa-arrow-left"></i>Input Barang Masuk</a></li>
                    <li><a href="?page=input-barang-keluar"><i class="fas fa-arrow-right"></i>Input Barang Keluar</a>
                    </li>
                ...
                <li><a href="homepage.php?logout" id="forLogout"><i class="fas fa-power-off"></i>Keluar</a></li>
            </ul>
        </nav>
    </div>
</aside>