...
if (isset($_POST['add-barang'])) {
    ...
    if ($kode_barang == " " || $nama_barang == " " || $lokasi == " " || $supplier == " " || $satuan == " " || $harga == " " || $stok == " " || $foto == " " || $ket == " ") {
        ...
        if ($harga < 0 || $stok < 0 || $harga == 0 || $stok == 0) {
            ...
            if ($response['types'] == "true") {
                $value = "'$kode_barang','$nama_barang','$lokasi','$supplier','$satuan','$waktu','$harga','$stok','$response[image]','$ket'";
                $response = $br->insert($table, $value, "?page=input-barang-masuk");
            }
        }
    }
}
