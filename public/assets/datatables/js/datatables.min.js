 ...
 *   https://datatables.net/download/#bs4/dt-2.0.8/b-3.0.2/fc-5.0.1/fh-4.0.1/kt-2.12.1/r-3.0.2/rg-1.5.0/sp-2.3.1
 *
 * Included libraries:
 *  DataTables 2.0.8, Buttons 3.0.2, FixedColumns 5.0.1, FixedHeader 4.0.1, KeyTable 2.12.1, Responsive 3.0.2, RowGroup 1.5.0, SearchPanes 2.3.1
 */
      ...
      (($.ext = C =
        {
          ...
          classes: {},
          builder:
            "bs4/dt-2.0.8/b-3.0.2/fc-5.0.1/fh-4.0.1/kt-2.12.1/r-3.0.2/rg-1.5.0/sp-2.3.1",
          errMode: "alert",
          feature: [],
          features: {},
          search: [],
    ...
    ? ((o = require("jquery")),
      ...
      "undefined" == typeof window
        ? (module.exports = function (e, t) {
            return (
              (e = e || window), (t = t || o(e)), r(e, t), n(t, 0, e.document)
            );
          })
    ...
    (n.modal = function (r) {
      return function (e, d, n, a) {
        if (s.fn.modal) {
          ...
          if (!1 === i) return !1;
          if (d) {
            if (!s.contains(l, m[0]) || e.index() !== m.data("dtr-row-idx"))
              return null;
            m.find("div.modal-body").empty().append(i);
          } else
            r &&
              r.header &&
              ((o = (t = m.find("div.modal-header")).find("button").detach()),
              t
                .empty()
