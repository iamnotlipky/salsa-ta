        ...
        if ($jumlah < 1) {
            ...
            if ($sisa['stok_barang'] < $jumlah) {
                ...
                if ($num > 0) {
                    ...
                    $value = "jumlah='$jumlah'";
                    $insert = $trans->update("table_pretransaksi", $value, "kd_transaksi = '$kd_transaksi' AND kd_barang", $barang, "?page=adminTransaksi");
                    header("location:PageAdmin.php?page=adminTransaksi");
                } else {
                    $value = "'$kd_pretransaksi','$kd_transaksi','$barang','$jumlah','$total'";
                    $insert = $trans->insert("table_pretransaksi", $value, "?page=adminTransaksi");
                    header("location:PageAdmin.php?page=adminTransaksi");
                }
            }
        }
...
if (isset($_GET['delete'])) {
    ...
    $response = $trans->delete("table_pretransaksi", $where, $id, "?page=adminTransaksi");
}
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-group">
                                                    <a class="btn btn-dark btn-block" href="#fajarmodal" data-toggle="modal">Pilih Barang</a>
                                                </div>
                                            </div>
                                        ...
                                        <button class="btn btn-dark" name="btnAdd"><i class="fa fa-cart-plus"></i> Tambahkan ke Antrian</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php if ($assoc2['count'] > 0 || isset($_POST['btnAdd'])) : ?>
                                <a class="btn btn-success" id="pembayaran" href="?page=adminrPembayaran">Lanjutkan ke pembayaran <i class="fa fa-cart-arrow-down"></i></a>
                            <?php endif ?>
                            <br><br>
                            <?php
                            $kr        = new lsp();
                                        ...
                                        <script>
                                            $("#btdelete<?php echo $no; ?>").click(function() {
                                                swal({
                                                    ...
                                                    if (isConfirm) {
                                                        window.location.href = "?page=adminTransaksi&delete&id=<?= $dd['kd_pretransaksi']; ?>";
                                                    }
                                                })
                                            })
                                        </script>
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                    ...
                    <tbody>
                        <?php foreach ($barangs as $brs) { ?>
                            <tr>
                                <td><a href="pageAdmin.php?page=adminTransaksi&getItem&id=<?php echo $brs['kd_barang'] ?>"><?php echo $brs['kd_barang'] ?></a></td>
