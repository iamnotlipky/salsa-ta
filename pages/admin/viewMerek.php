<?php 
    ...
    $autokode = $me->autokode($table,"kd_merek","MK");
    ...
    if (isset($_GET['delete'])) {
        ...
        if ($cek['count'] > 0) {
            $response = ['response'=>'negative','alert'=>'Merek Sudah Dipakai Dibarang, Tidak Dapat Dihapus!'];
        }else{
        $where    = "kd_merek";
    ...
    if (isset($_POST['getUpdate'])) {
        ...
        if ($_FILES['foto']['name'] == "") {
            ...
            if ($response['types'] == "true") {
                ...
                $response = ['response'=>'negative','alert'=>'Gambar Tidak Dapat Digunakan!'];
            }
        }
    }
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title mb-3">Input Data Merek</strong>
                        </div>
                        <div class="card-body">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <a href="?page=viewMerek" class="btn btn-danger">Batal</a>
                                <?php endif ?>
                                <?php if (!isset($_GET['edit'])): ?>    
