					...
					<div class="card">
						<form method="post">
							...
							<div class="card-body">
								...
								<a href="?page=periode" class="btn btn-danger">Muat Ulang</a>
								<br><br>
								<?php if (isset($_POST['dateAwal'])) : ?>
									<a target="_blank" href="pages/manager/BarangPeriodePrint.php?dateAwal=<?php echo $param ?>&dateAkhir=<?php echo $param1 ?>" class="btn btn-dark"><i class="fa fa-print"></i> Cetak</a>
								<?php endif ?>
								<br><br>
