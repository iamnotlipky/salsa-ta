...
$rg = new lsp();
$table = "table_user";
$autokode = $rg->autokode($table, "kd_user", "PE");
                ...
                <div class="col-md-5">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title mb-3">Input Data Pegawai</strong>
                        </div>
                        <div class="card-body">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="file" class="form-control" name="foto" id="gambar" class="form-control-file">
